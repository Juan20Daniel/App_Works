...
import { signInWithEmailUseCase, suma} from './signInWithEmailUseCase';
import { AppError } from '@/shared';
test('Prueba de suma', () => {
    expect(suma(5,5)).toEqual(10);
})
...
//     test('Comportamiento dinámico completo', async () => {
//         const resultAuthJuan = createAuthResultSimulation({email:'juan@gmail.com'});
//         const resultAuthFernando = createAuthResultSimulation({email:'fernando@gmail.com'});

//         repository.signInWithEmail.mockImplementation(
//             async (email, password) => {
//                 if(email === 'juan@gmail.com' && password === '123456789') {
//                     return resultAuthJuan;
//                 }
//                 if(email === 'fernando@gmail.com' && password === '987654321') {
//                     return resultAuthFernando;
//                 }

//                 if(email === 'pepee@gmail.com' && password !== '1234567899876543') {
//                     throw new AppError('NOT_FOUND', 'Credenciales incorrectas');
//                 }
...
//         const resultJuan = await signInWithEmailUseCase(repository, 'juan@gmail.com','123456789');
//         const resultFernando = await signInWithEmailUseCase(repository, 'fernando@gmail.com','987654321');
//         expect(resultJuan).toBe(resultAuthJuan);
//         expect(resultFernando).toBe(resultAuthFernando);
//         await expect(
//             signInWithEmailUseCase(repository, 'pepee@gmail.com','12345678')
//         ).rejects.toThrow('Credenciales incorrectas');

//         await expect(
//             signInWithEmailUseCase(repository, 'carlos@gmail.com','12345678')
//         ).rejects.toThrow('Usuario no encontrado');
        
//         expect(repository.signInWithEmail).toHaveBeenCalledTimes(4);
//     });
// });